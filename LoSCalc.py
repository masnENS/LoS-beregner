...
class calculate(QThread): # The actual LoS-calculations
    ...
    def run(self):
        if self.inputOK:  # Don't run if the input validation failed
            ...
            #logon = ['ASN','ASN'] # ['user','password'], need user and password from kortforsyningen
            ...
            #data_out = multibase.findBase(self.basePosition[0])
            ...
            LoSList = [] # LoS for th8e client position (0 or 1)
